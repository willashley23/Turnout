...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  Event.create!({title: "Small Buisness Expo 2016", price: 35, description: "business", tag:"career", image_url: "assets/business.jpeg", date: DateTime.new(2016,10,15,17), location: "Oakland, CA" })